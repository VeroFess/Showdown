...
NTSTATUS NTAPI HookedNtAllocateVirtualMemory(
  ...
  auto result = NtAllocateVirtualMemory(ProcessHandle, BaseAddress, ZeroBits,
...
NTSTATUS NTAPI HookedNtProtectVirtualMemory(_In_ HANDLE ProcessHandle,
  ...
  return NtProtectVirtualMemory(ProcessHandle, BaseAddress, RegionSize,
...
NTSTATUS NTAPI HookedNtCreateSection(
  ...
  return NtCreateSection(SectionHandle, DesiredAccess, ObjectAttributes,
